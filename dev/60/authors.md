...
Source:
[`DESCRIPTION`](https://github.com/NovoNordisk-OpenSource/S7schema/blob/dependabot/npm_and_yarn/dev/npm_and_yarn-d94a6574ee/DESCRIPTION)

Thomsen A, Phelps M (2026). *S7schema: 'S7' Framework for
Schema-Validated YAML Configuration*. R package version 0.1.1.9002,
