...
Source:
[`DESCRIPTION`](https://github.com/NovoNordisk-OpenSource/S7schema/blob/feat/include-failing-value/DESCRIPTION)

Thomsen A, Phelps M (2026). *S7schema: 'S7' Framework for
Schema-Validated YAML Configuration*. R package version 0.1.1.9004,
