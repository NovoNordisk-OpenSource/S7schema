...
- Unquoted values that look like dates (e.g. `version: 2025-08-06`) are
  now validated as strings instead of dates, which is what
  [`yaml::read_yaml()`](https://yaml.r-lib.org/reference/read_yaml.html)
  returns for the same file
  ([\#67](https://github.com/NovoNordisk-OpenSource/S7schema/issues/67)).
