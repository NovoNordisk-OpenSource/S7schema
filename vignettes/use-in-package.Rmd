---
title: "Use in a package"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Use in a package}
...
By subclassing `S7schema`, your package gets schema validation,
...
`S7::validate()` works on the subclass just like on the parent:
